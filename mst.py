    ...
    while True:
        ...
        for arc in arcs:
            ...
            if tail_rep == head_rep:
                continue
            if tail_rep not in gen_arc_by_tail_rep or ((gen_arc_by_tail_rep[tail_rep].weight > arc.weight and opt == "min") or (gen_arc_by_tail_rep[tail_rep].weight < arc.weight and opt == "max")):
